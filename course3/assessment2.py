...
# 6---Write code using zip and filter so that these lists (l1 and l2) are combined into one big list and assigned to the variable opposites if they are both longer than 3 characters eac
l1 = ['left', 'up', 'front']
l2 = ['right', 'down', 'back']
l3 = zip(l1, l2)
# print(l3)
...
print(pop_info)
endangered = [names for (names, pops) in pop_info if pops < 2500]
print(endangered)
